class Detail {
  ...
  Detail({this.code, this.message, this.data});

  Detail.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new DetailGoods.fromJson(json['data']) : null;
  }
...
class DetailGoods {
  ...
  DetailGoods({this.goodInfo, this.goodComments, this.advertesPicture});

  DetailGoods.fromJson(Map<String, dynamic> json) {
